...
<!--                        <button type="button" class="btn btn-primary btn pull-left" onclick="import_data();">Import data</button>-->
                       <button type="button" class="btn btn-primary btn pull-right" onclick="location.href='<?php echo base_url(); ?>Material_cont/excel'">Export data</button>
                   </table>
...
<?php } ?>
  ...
  $.ajax({
   url:"<?php echo base_url(); ?>Material_cont/import",
   method:"POST",
