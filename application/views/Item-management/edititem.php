                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form"  action="<?php echo base_url(); ?>Item_cont/updateitem/<?php echo $item->item_id ; ?>" method="post" id="updt" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="hidden" name="mode" value="updateDetails">
                                    <label class="control-label">Enter item Name</label>    
                                    <input  type="text"  placeholder="Item Name" class="form-control test" name="itemname" id="item" label="Item" value="<?php echo $item->item_name ?>" onblur="check_if_exists();">
     ...
     ?>
                ...
                <span id="tax_error" style="color: red"></span><br>
                       ...
                       <span id="oldprice_error" style="color: red"></span><br>
                        ...
                        <label class="control-label">Calculate new price price</label>            
                        <label for="chkYes">
