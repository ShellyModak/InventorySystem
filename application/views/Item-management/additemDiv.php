                     ...
                     <div class="form-group">
                        <div class=" col-md-6">
                                <input type="hidden" name="mode" value="updateDetails">
                                    ...
                                    <input  type="text"  placeholder="Item Name" class="form-control test" name="itemname" id="item" label="Item" maxlength="20" onblur="check_if_exists();">
...
<div class="row">
            ...
            <div id="addMoreHtml" class="test">
                ...
                <p id="addMoreHtml_error" style="color: red;"></p>
                    ...
                    <div class="form-group col-lg-12 srchFlds test" id="div_<?php echo $nxtCount;?>">
                        ...
                        <div class="col-lg-4 test_parent">
    ...
    <span id="unit_error" style="color: red"></span> 
    </div>
</div>
<div class="row">
     <div class="form-group">                
         <div class=" col-md-3">
                        <label class="control-label">Mode of price</label> <br>           
                        <lable for="chkYes">
...
//     {
    ...
    if(material != '')
  {
            ...
            {
           //= $(event.target).closest('.test_parent').find('.unit_test');
                //alert($(current_this).parents('.srchFlds').find('.unit_test').attr('test-unit_test'));
                $(current_this).parents('.srchFlds').find('.unit_test').html(data);
                //var example1 = $(this).parents('.test_parent').find('.unit_test');
               //var title= $(this).parent('.test_parent').find('.unit_test');
               // $("#chkYes").prop("checked",false);
                //alert(title);exit();
//                console.log(example1);exit();
             //$('.unit_test').html(data);
            }
           });
          }
    ...
    function check(current_this){
     ...
     if(qty<0){
      ...
      alert('please enter a positive value');
       ...
       // $(current_this).parents('.srchFlds').find('.unit_test').val('');
       // $(current_this).parents('.srchFlds').find('.material_test').val('');
            ...
            $.ajax({
						 ...
						 success: function(response){
							 // $('#addMoreHtml').append(response);
							  ...
							  {
                                 // alert("Please enter some raw material");
								   //$('#actionBtn_'+c).html('');
							  }
						 }
					});
...
//        }
       // alert(total_price);
        ...
        final_manual_price=parseFloat(total_price).toFixed(2);
             console.log(final_manual_price);
        ...
        // });       
           ...
           // $("#btn").click(function(){
                ...
                var v1=0;
                    ...
                    //var material=$('.material_test').val();
                    //var unit=$('.unit_test').val();
